...
var blue_piece = preload("res://actors/blue_piece.tscn")
var green_piece = preload("res://actors/green_piece.tscn")
var yellow_piece = preload("res://actors/yellow_piece.tscn")
var piece_type_set = [blue_piece, green_piece, yellow_piece]
...
func put_piece_in_stage(select_type, grid_pos):
	...
	var piec = piece_type_set[select_type].instance()
